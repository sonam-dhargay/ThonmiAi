...
export const TIBETAN_STRINGS = {
  ...
  // Welcome View
  welcomeTitle: "ཁྱེད་ཀྱིས་ཅི་ཞིག་ཤེས་འདོད་འདུག",
  welcomeSubtitle: "ང་ནི་བོད་ཀྱི་སྐད་ཡིག་བཀོལ་སྤྱོད་བྱེད་སའི་ཁོར་ཡུག་ཅིག་བསྐྲུན་རྒྱུར་རོགས་པ་བྱེད་མཁན་གྱི་ཐོན་མི་AI རིག་ནུས་ཡིན།",
  examplePrompts: [
  ...
  examplePromptsNote: "གོང་གསལ་ནི་དཔེ་མཚོན་ཙམ་ཡིན། ཁྱེད་ཀྱིས་གང་ཡང་འདྲིས་ཆོག",
